...
ln -sfn "/Programs/Udev/${UDEV_VERSION}/Commands/udevadm" "${AUZIX_ROOT}/System/Compatibility/bin/udevadm"
ln -sfn "/Programs/Udev/${UDEV_VERSION}/Commands/udevadm" "${AUZIX_ROOT}/System/Compatibility/lib/systemd/systemd-udevd"
ln -sfn "/Programs/Udev/${UDEV_VERSION}/Commands/udevadm" "${AUZIX_ROOT}/System/Compatibility/usr/bin/udevadm"
mkdir -p "${AUZIX_ROOT}/System/Compatibility/usr/lib/systemd"
ln -sfn "/Programs/Udev/${UDEV_VERSION}/Commands/udevadm" "${AUZIX_ROOT}/System/Compatibility/usr/lib/systemd/systemd-udevd"
