...
export LD_LIBRARY_PATH="/Programs/Midori/current/Libraries:/Programs/Midori/current/Resources/midori:/System/Compatibility/lib/x86_64-linux-gnu:/System/Compatibility/lib64${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}"
